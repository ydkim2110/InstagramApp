...
import com.example.anti2.instagramproject.Utils.SectionsStatePageAdapter;
...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    private void getIncomingIntent() {
        ...
        if(intent.hasExtra(getString(R.string.calling_activity))) {
            ...
            setViewPager(pageAdapter.getFragmentNumber(getString(R.string.edit_profile_fragment)));
        }
    }
    ...
    private void setupFragments() {
        ...
        pageAdapter.addFragment(new SignOutFragment(), getString(R.string.sign_out_fragment)); // fragment 1
    }
